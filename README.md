...
```
docker-compose run --rm -w /data/www php-fpm composer update
```
`-w /data/www`为在php-fpm的工作区域，zPhal项目也是挂载在里面，所有我们可以直接在容器里运行composer。
